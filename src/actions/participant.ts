...
export async function addParticipant(campaignId: string, formData: FormData) {
...
export async function editParticipant(campaignId: string, participantId: string, formData: FormData) {
  const { user } = await requireCampaignAccess(campaignId);
